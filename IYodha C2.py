...
methods = """
\033[0;36m Im lazy here, so this is our methods without copyright
\033[0;36m  ╔═════════════════════════╦════════════════════════════╗
...
raw = """
\033[0;36m				YodhaGTPS\033[0;34mTools
\033[0;36m				YodhaGTPS\033[0;34mTools
\033[0;36m			        YodhaGTPS\033[0;34mTools
\033[0;36m                            Hosted By :\033[0;34m Yodha
...
private = """
\033[0;36m		                Yodha\033[0;34mTools
\033[0;36m                              YodhaGTPS\033[0;34mTools		        
\033[0;36m                              YodhaGTPS\033[0;34mTools
\033[0;36m                            Hosted By :\033[0;34m Yodha
...
\033[0;36m                              YodhaGTPS\033[0;34mTools		        
\033[0;36m                             YodhaGTPS\033[0;34mTools
\033[0;36m                            Hosted By :\033[0;43m Yodha

\033[0;34mAttack\033[36mSent\033[0;34mSucessfully
\033[0;34mType HELP For informations
...
\033[0;36m
\033[0;36m            ╚╦════════════════════════╦╩╦══════════════════════════╦╝
\033[0;36m	     ║1. \033[0;34mMETHODS					   \033[0;36m║
\033[0;36m	     ║2. \033[0;34mPLAN						   \033[0;36m║
\033[0;36m            ╔╩════════════════════════╝ ╚══════════════════════════╩╗
...
\033[0;36m                              Yodha\033[0;34mTools
\033[0;36m                            Hosted By :\033[0;34m Yodha
\033[0;36m Make You Login Secure To our service :)"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] IYodha C2 | Api Connected [5] | Backup Server [1] | Online User [2] | Admin: [Yodha] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		sin = input("\033[0;36m{}\033[0;34m@[C2 Yodha]\033[36m--> \033[0;31m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("cls")
			print (banner)
		...
		if sinput == "cls":
			...
			os.system ("cls")
			print ("You Dont Have Access To this apis!")
			main()
		elif sinput == "":
			print(invalid)
			main()
